...
import com.portal.api.message.KafkaProducerMassage;
...
public class CarPostController {
    ...
    @Autowired
    private KafkaProducerMassage kafkaProducerMassage;
    ...
    public ResponseEntity postCarForSale(@RequestBody CarPostDTO carPostDTO){
        kafkaProducerMassage.sendMassage(carPostDTO);
    ...
    public ResponseEntity deleteCarForSale(@PathVariable("id") String id){
        carPostStoreService.removeCarForSalle(id);
        return new ResponseEntity<>(HttpStatus.OK);
    }
